				...
				<div class="container">
					<?php foreach ($users as $users):?>
						<?php foreach ($dosen as $dosen):?>
							<form action="<?php echo base_url('proses_ubah_profile_dosen')?>" method="post" class="data-parsley-validate novalidate">
								...
								<div class="form-group">
									<label for="userTempatLahir">Tanggal Lahir<span class="text-danger">*</span></label>
								...
								<input type="hidden" name="foto" value="<?php echo $dosen->foto?>">
