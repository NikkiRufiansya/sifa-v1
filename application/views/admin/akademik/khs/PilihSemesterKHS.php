				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="card-box table-responsive">
							...
							<form action="<?php echo base_url('lihat_khs_semester') ?>" method="post">
							...
							<a href="<?php echo base_url()?>lihat_khs_all_semester/<?= $mhs['id']?>" class="btn btn-danger">Lihat Semua Semester</a>
