	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Data Jadwal Kuliah</b></h4>
						<form action="<?php echo base_url('proses_tambah_jadwal') ?>" method="post">
								...
								<div class="form-group">
									...
									<div>
										<div class="input-daterange input-group">
											<input type="time" class="form-control" placeholder="Jadwal Masuk"
												   name="jadwal_masuk"/>
											<span class="input-group-addon bg-custom text-white b-0">to</span>
											<input type="time" class="form-control" placeholder="Jadwal Selesai"
												   name="jadwal_selesai"/>
										</div>
									</div>
								</div>
