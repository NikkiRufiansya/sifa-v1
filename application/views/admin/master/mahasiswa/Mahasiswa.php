				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="card-box table-responsive">
							<a href="<?php echo base_url('tambah_mahasiswa')?>" class="btn btn-primary" style="margin-bottom: 20px;">Tambah Mahasiswa</a>
							<table id="datatable" class="table table-striped table-bordered">
								...
								<?php foreach ($mahasiswa as $key):?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url()?>ubah_mahasiswa/<?= $key->id?>"><i class="glyphicon glyphicon-edit"></i></a>
											||
											<a href="<?php echo base_url()?>hapus_mahasiswa/<?= $key->id?>/<?= $key->users_id?>"><i class="glyphicon glyphicon-trash"></i></a>
										</td>
									</tr>
								<?php endforeach;?>
								</tbody>
