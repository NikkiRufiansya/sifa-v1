	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Data Program </b></h4>
						<div class="card-box table-responsive">
							<a href="<?php echo base_url('tambah_program') ?>" class="btn btn-primary"
							...
							<table id="datatable" class="table table-striped table-bordered">
								...
								<?php foreach ($program as $key): ?>
									<tr>
										<td><?= $key->kode_program ?></td>
										<td><?= $key->nama_program ?></td>
										<td>
											<a href="<?php echo base_url() ?>ubah_program/<?= $key->id ?>"><i
													class="glyphicon glyphicon-edit"></i></a>
											||
											<a href="<?php echo base_url() ?>hapus_program/<?= $key->id ?>"><i
