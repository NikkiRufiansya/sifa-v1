	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Data Kurikulum</b></h4>
						<div class="card-box table-responsive">
							<a href="<?php echo base_url('tambah_kurikulum') ?>" class="btn btn-primary"
							   style="margin-bottom: 20px;">Tambah Kurikulum </a>
							<table id="datatable" class="table table-striped table-bordered">
								...
								<?php foreach ($kurikulum as $key): ?>
									<tr>
										...
										<td><?= $key->kode_kurikulum ?></td>
										<td><?= $key->nama_kurikulum ?></td>
										<td>
											<a href="<?php echo base_url() ?>ubah_kurikulum/<?= $key->id ?>"><i
													class="glyphicon glyphicon-edit"></i></a>
											||
											<a href="<?php echo base_url() ?>hapus_kurikulum/<?= $key->id ?>"><i
