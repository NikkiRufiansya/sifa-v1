	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Data Ruangan </b></h4>
						<div class="card-box table-responsive">
							<a href="<?php echo base_url('tambah_ruangan') ?>" class="btn btn-primary"
							   style="margin-bottom: 20px;">Tambah Ruangan </a>
								...
								<?php foreach ($ruangan as $key): ?>
									<tr>
										...
										<td>
											...
											||
											<a href="<?php echo base_url() ?>hapus_ruangan/<?= $key->id ?>"><i
