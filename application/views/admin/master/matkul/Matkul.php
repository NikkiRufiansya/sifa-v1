	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Data matkul</b></h4>
						<div class="card-box table-responsive">
							<a href="<?php echo base_url('tambah_matkul') ?>" class="btn btn-primary"
							   style="margin-bottom: 20px;">Tambah matkul </a>
							<table id="datatable" class="table table-striped table-bordered">
								...
								<?php foreach ($matkul as $key): ?>
									<tr>
										...
										<td><?= $key->semester?></td>
										<td><?= $key->sks?></td>
										<td><?= $key->penanggung_jawab?>
										<td>
											<a href="<?php echo base_url() ?>ubah_matkul/<?= $key->id ?>"><i
													class="glyphicon glyphicon-edit"></i></a>
											||
											<a href="<?php echo base_url() ?>hapus_matkul/<?= $key->id ?>"><i
