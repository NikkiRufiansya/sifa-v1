	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Tambah Kampus </b></h4>
						<div class="card-box table-responsive">
							<form action="<?php echo base_url('proses_tambah_kampus')?>" method="post">
								<div class="form-group">
									<label for="">Kode Kampus</label>
									<input type="text" name="kode_kampus" id="" class="form-control" placeholder="Kode Kampus">
								</div>
								<div class="form-group">
									<label for="">Nama Kampus</label>
									<input type="text" name="nama_kampus" id="" class="form-control" placeholder="Nama Kampus">
								</div>
								<div class="form-group">
									<label for="">Alamat</label>
									<input type="text" name="alamat_kampus" id="" class="form-control" placeholder="Alamat">
								</div>
								<div class="form-group">
