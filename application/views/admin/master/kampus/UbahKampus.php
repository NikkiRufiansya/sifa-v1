	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="m-t-0 header-title"><b>Ubah Kampus </b></h4>
						<div class="card-box table-responsive">
							<?php foreach ($kampus as $key):?>
							<form action="<?php echo base_url('proses_ubah_kampus')?>" method="post">
								<div class="form-group">
									<label for="">Kode Kampus</label>
									<input type="hidden" name="id" value="<?= $key['id']?>">
									<input type="text" value="<?= $key['kode_kampus']?>" name="kode_kampus" id="" class="form-control" placeholder="Kode Kampus">
								</div>
								<div class="form-group">
									<label for="">Nama Kampus</label>
									<input type="text" value="<?= $key['nama_kampus']?>" name="nama_kampus" id="" class="form-control" placeholder="Nama Kampus">
								</div>
								<div class="form-group">
									<label for="">Alamat</label>
									<input type="text" value="<?= $key['alamat_kampus']?>" name="alamat_kampus" id="" class="form-control" placeholder="Alamat">
								</div>
								<div class="form-group">
