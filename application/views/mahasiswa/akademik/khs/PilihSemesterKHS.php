				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="card-box table-responsive">
							...
							<form action="<?php echo base_url('mhs_lihat_khs_semester') ?>" method="post">
								<input type="hidden" name="mahasiswa_id" value="<?= $mhs->id ?>">
								<input type="hidden" name="prodi_id" value="<?= $mhs->prodi_id ?>">
								<div class="form-group">
									<label for="">Lihat KHS Per Semester</label>
							...
							<a href="<?php echo base_url()?>mhs_lihat_khs_all_semester/<?= $mhs->id?>" class="btn btn-danger">Lihat Semua Semester</a>
